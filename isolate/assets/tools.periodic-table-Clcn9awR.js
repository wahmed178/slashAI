import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{t as r}from"./AppShell-BPLOjQCr.js";var i=e(t()),a=n(),o=`1,H,Hydrogen,1.008,nonmetal,1,1,"Lightest element - fuels the Sun via fusion."
...
118,Og,Oganesson,294,noble,18,7,"Heaviest known element; only atoms ever made."`.split(`
`).map(e=>{let t=e.match(/^(\d+),([^,]+),([^,]+),([^,]+),([^,]+),(\d+),(\d+),"(.+)"$/);if(!t)throw Error(`Bad element row: `+e);return{n:Number(t[1]),sym:t[2],name:t[3],mass:t[4],cat:t[5],group:Number(t[6]),period:Number(t[7]),fact:t[8]}}),s={nonmetal:`#3fb950`,noble:`#a371f7`,metal:`#58a6ff`,metalloid:`#d29922`,halogen:`#f778ba`,lanthanide:`#f0883e`,actinide:`#f85149`,transition:`#79c0ff`,"post-transition":`#8b949e`},c={nonmetal:`Nonmetal`,noble:`Noble gas`,metal:`Alkali/alkaline metal`,metalloid:`Metalloid`,halogen:`Halogen`,lanthanide:`Lanthanide`,actinide:`Actinide`,transition:`Transition metal`,"post-transition":`Post-transition`};function l(){let[e,t]=(0,i.useState)(null),[n,l]=(0,i.useState)(``),u=n.trim().toLowerCase(),d=u?new Set(o.filter(e=>e.name.toLowerCase().includes(u)||e.sym.toLowerCase()===u||String(e.n)===u).map(e=>e.n)):null;return(0,a.jsxs)(r,{wide:!0,title:`Periodic Table`,children:[(0,a.jsxs)(`header`,{className:`mb-5`,children:[(0,a.jsx)(`h1`,{className:`text-2xl font-bold tracking-tight text-foreground`,children:`⚗️ Periodic Table`}),(0,a.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:`All 118 elements - tap any cell for facts. Search by name, symbol or number.`})]}),(0,a.jsxs)(`div`,{className:`mx-auto max-w-4xl space-y-4`,children:[(0,a.jsx)(`input`,{value:n,onChange:e=>l(e.target.value),placeholder:`Search: gold, Au, 79…`,className:`h-11 w-full rounded-xl border border-border bg-surface px-4 text-sm text-foreground focus:border-primary focus:outline-none`}),e&&(0,a.jsx)(`div`,{className:`rounded-xl border p-4`,style:{borderColor:s[e.cat],background:`color-mix(in oklab, `+s[e.cat]+` 8%, transparent)`},children:(0,a.jsxs)(`div`,{className:`flex items-start gap-3`,children:[(0,a.jsx)(`span`,{className:`grid size-14 shrink-0 place-items-center rounded-lg text-2xl font-black`,style:{background:s[e.cat],color:`#0d1117`},children:e.sym}),(0,a.jsxs)(`div`,{className:`min-w-0`,children:[(0,a.jsxs)(`p`,{className:`text-lg font-bold text-foreground`,children:[e.name,` `,(0,a.jsxs)(`span`,{className:`text-[12px] font-semibold text-muted-foreground`,children:[`#`,e.n,` · `,e.mass,` u`]})]}),(0,a.jsx)(`p`,{className:`text-[12px] font-semibold`,style:{color:s[e.cat]},children:c[e.cat]}),(0,a.jsx)(`p`,{className:`mt-1 text-[13px] text-muted-foreground`,children:e.fact})]}),(0,a.jsx)(`button`,{onClick:()=>t(null),className:`ml-auto text-muted-foreground hover:text-foreground`,children:`✕`})]})}),(0,a.jsx)(`div`,{className:`overflow-x-auto pb-2`,children:(0,a.jsxs)(`div`,{className:`grid min-w-[680px] gap-1`,style:{gridTemplateColumns:`repeat(18, minmax(34px, 1fr))`,gridTemplateRows:`repeat(10, 40px)`},children:[o.map(e=>{let n=d?!d.has(e.n):!1;return(0,a.jsxs)(`button`,{onClick:()=>t(e),className:`rounded-[5px] border p-0.5 text-center transition-all duration-150 hover:scale-110`,style:{gridColumn:e.group,gridRow:e.period,borderColor:n?`transparent`:s[e.cat]+`66`,background:n?`transparent`:s[e.cat]+`22`,opacity:n?.25:1},title:e.name,children:[(0,a.jsx)(`span`,{className:`block text-[7px] leading-none text-muted-foreground`,children:e.n}),(0,a.jsx)(`span`,{className:`block text-[12px] font-black leading-tight`,style:{color:s[e.cat]},children:e.sym})]},e.n)}),o.filter(e=>e.period===6&&e.cat===`lanthanide`).map(e=>(0,a.jsxs)(`button`,{onClick:()=>t(e),className:`rounded-[5px] border p-0.5 text-center transition-all duration-150 hover:scale-110`,style:{gridColumn:e.n-57+3,gridRow:9,borderColor:s[e.cat]+`66`,background:s[e.cat]+`22`},title:e.name,children:[(0,a.jsx)(`span`,{className:`block text-[7px] leading-none text-muted-foreground`,children:e.n}),(0,a.jsx)(`span`,{className:`block text-[12px] font-black leading-tight`,style:{color:s[e.cat]},children:e.sym})]},`la`+e.n)),o.filter(e=>e.period===7&&e.cat===`actinide`).map(e=>(0,a.jsxs)(`button`,{onClick:()=>t(e),className:`rounded-[5px] border p-0.5 text-center transition-all duration-150 hover:scale-110`,style:{gridColumn:e.n-89+3,gridRow:10,borderColor:s[e.cat]+`66`,background:s[e.cat]+`22`},title:e.name,children:[(0,a.jsx)(`span`,{className:`block text-[7px] leading-none text-muted-foreground`,children:e.n}),(0,a.jsx)(`span`,{className:`block text-[12px] font-black leading-tight`,style:{color:s[e.cat]},children:e.sym})]},`ac`+e.n))]})}),(0,a.jsx)(`div`,{className:`flex flex-wrap gap-x-4 gap-y-1.5 text-[11px] text-muted-foreground`,children:Object.entries(c).map(([e,t])=>(0,a.jsxs)(`span`,{className:`inline-flex items-center gap-1.5`,children:[(0,a.jsx)(`span`,{className:`size-2.5 rounded-sm`,style:{background:s[e]}}),t]},e))})]})]})}export{l as component};