...
const CURATED = [
  ["/HandwrittenNotesImage", "Handwritten Notes Image", "Documents & OCR", "Handwriting", "document",
    ...
    ["handwriting", "notes", "image", "realistic"], "easy", true],
  ["/Explode", "Exploded View", "Image & Vision", "Diagrams", "image",
    ...
    ["diagram", "exploded", "technical", "parts"], "medium", true],
  ["/Scan", "Document Scan", "Documents & OCR", "OCR", "document",
    ...
    ["scan", "ocr", "cleanup", "pdf"], "easy", true],
  ["/100xUpscale", "100x Upscale", "Image & Vision", "Upscaling", "image",
    ...
    ["upscale", "resolution", "restore"], "medium", true],
  ["/Summarize", "Summarize Anything", "Writing & Communication", "Summaries", "text",
    ...
    ["summary", "tldr", "condense"], "easy", true],
  ["/Explain", "Explain Clearly", "Learning & Education", "Explainers", "learning",
    ...
    ["explain", "learning", "clarity"], "easy", true],
  ["/PromptImprove", "Improve My Prompt", "General AI", "Prompting", "general",
    ...
    ["prompt", "meta", "quality"], "easy", true],
  ["/CleanCsv", "Clean CSV", "Data & Analytics", "Cleaning", "data",
    ...
    ["csv", "cleaning", "dedupe"], "easy", true],
  ["/CodeReview", "Code Review", "Coding & Development", "Code Review", "coding",
    ...
    ["review", "quality", "bugs"], "medium", true],
  ["/MeetingRecap", "Meeting Recap", "Productivity", "Recaps", "productivity",
    ...
    ["meeting", "notes", "actions"], "easy", true],
  ["/Deblur", "Deblur Image", "Image & Vision", "Restoration", "image",
    ...
    ["deblur", "sharpen", "restore"], "easy", false],
  ["/TranslateDoc", "Translate Document", "Translation & Languages", "Translation", "text",
    ...
    ["translate", "document", "layout"], "medium", true],
  ["/DailyPlan", "Daily Plan", "Productivity", "Planning", "productivity",
    ...
    ["planning", "focus", "day"], "easy", true],
  ["/RegexBuild", "Build Regex", "Coding & Development", "Regex", "coding",
    ...
    ["regex", "pattern", "parsing"], "medium", false],
  ["/SqlFromText", "SQL From Text", "Data & Analytics", "SQL", "data",
    ...
    ["sql", "query", "analytics"], "medium", true],
  ["/AltText", "Alt Text", "Image & Vision", "Accessibility", "image",
    ...
    ["accessibility", "alt-text", "a11y"], "easy", false],
  ["/Anonymize", "Anonymize Text", "Security & Privacy", "Privacy", "general",
    ...
    ["privacy", "pii", "redaction"], "easy", true],
  ["/Storyboard", "Storyboard Video", "Video", "Storyboards", "video",
    ...
    ["video", "storyboard", "shots"], "medium", true],
  ["/CompareOptions", "Compare Options", "Data & Analytics", "Comparison", "text",
    ...
    ["compare", "decision", "table"], "easy", true],
  ["/Rubber", "Rubber Duck", "Coding & Development", "Debugging", "coding",
    ...
    ["debug", "thinking", "questions"], "easy", false],
];
...
for (const [command, title, category, subcategory, type, description, howToUse, example, tags, difficulty, featured] of CURATED) {
  push({
    id: slug(command),
    command,
    title,
