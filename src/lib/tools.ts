...
export const TOOLS: AiTool[] = [
  ...
  {
    id: "grok-imagine", name: "Grok Imagine", vendor: "xAI", category: "Image",
    bestFor: "Fast image + video generation in Grok", freeTier: "Free on grok.com & X",
    pricing: "Freemium", difficulty: "Beginner", url: "https://grok.com/imagine",
    query: "image", icon: "🚀", tags: ["text-to-image", "video", "xai"], trending: true,
  },
  {
    id: "qwen-chat", name: "Qwen Chat", vendor: "Alibaba", category: "General AI",
    bestFor: "Free chat, vision and image generation", freeTier: "Completely free",
    pricing: "Free", difficulty: "Beginner", url: "https://chat.qwen.ai",
    query: "research", icon: "🐉", tags: ["chat", "free", "multimodal", "open-source"], trending: true,
  },
  {
    id: "kimi", name: "Kimi", vendor: "Moonshot AI", category: "Research",
    bestFor: "Long-document analysis and search-grounded chat", freeTier: "Free",
    pricing: "Free", difficulty: "Beginner", url: "https://kimi.com",
    query: "summarize", icon: "🌙", tags: ["chat", "long-context", "research", "free"], trending: true,
  },
  {
    id: "notebooklm", name: "NotebookLM", vendor: "Google", category: "Research",
    bestFor: "Chat with your docs + viral audio overviews", freeTier: "Free with Google account",
    pricing: "Free", difficulty: "Beginner", url: "https://notebooklm.google.com",
    query: "summarize", icon: "📓", tags: ["documents", "podcast", "study", "google"], trending: true,
  },
  {
    id: "hailuo", name: "Hailuo AI", vendor: "MiniMax", category: "Video",
    bestFor: "Free AI video generation from text/image", freeTier: "Free daily credits",
    pricing: "Freemium", difficulty: "Beginner", url: "https://hailuoai.video",
    query: "text to video", icon: "🌊", tags: ["text-to-video", "image-to-video", "free"], trending: true,
  },
  {
    id: "kling", name: "Kling AI", vendor: "Kuaishou", category: "Video",
    bestFor: "High-quality image-to-video motion", freeTier: "Free daily credits",
    pricing: "Freemium", difficulty: "Beginner", url: "https://klingai.com",
    query: "text to video", icon: "🐉", tags: ["text-to-video", "image-to-video", "motion"], trending: true,
  },
  {
    id: "veo", name: "Google Veo", vendor: "Google", category: "Video",
    bestFor: "Cinematic text-to-video with sound", freeTier: "Limited free via Gemini",
    pricing: "Freemium", difficulty: "Beginner", url: "https://labs.google/fx/tools/video-fx",
    query: "video", icon: "🎞️", tags: ["text-to-video", "cinematic", "audio", "google"], trending: true,
  },
  {
    id: "grok", name: "Grok", vendor: "xAI", category: "General AI",
    bestFor: "Real-time X-grounded answers, unfiltered mode", freeTier: "Free tier on X",
    pricing: "Freemium", difficulty: "Beginner", url: "https://grok.com",
    query: "research", icon: "⚡", tags: ["chat", "realtime", "x", "reasoning"], trending: true,
  },
  {
    id: "mistral-lechat", name: "Le Chat", vendor: "Mistral AI", category: "General AI",
    bestFor: "Fast European AI assistant with web search", freeTier: "Free",
    pricing: "Freemium", difficulty: "Beginner", url: "https://chat.mistral.ai",
    query: "research", icon: "🇪🇺", tags: ["chat", "fast", "open-source", "search"],
  },
  {
    id: "perplexity", name: "Perplexity", vendor: "Perplexity AI", category: "Research",
    bestFor: "Cited, search-grounded answers", freeTier: "Free with limits",
    pricing: "Freemium", difficulty: "Beginner", url: "https://perplexity.ai",
    query: "research", icon: "🔎", tags: ["search", "citations", "research"],
  },
  {
