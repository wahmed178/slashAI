...
export const TOOL_SECTIONS: SlashKitSection[] = [
  {
    ...
    tools: [
      ...
      { slug: "watermark", name: "Watermark Maker", desc: "Add text watermarks to images, in-browser", icon: "💧", noUpload: true },
      ...
      { slug: "days-between", name: "Days Between Dates", desc: "Days, weekdays, months between any two dates", icon: "📅" },
      { slug: "random-picker", name: "Random Picker", desc: "Fair winner picker for lists, no-repeat mode", icon: "🎰" },
      { slug: "click-speed", name: "Click Speed Test", desc: "CPS test in 1/5/10/30s rounds, records kept", icon: "🖱️" },
    ],
  },
  {
    title: "File & Document",
    ...
    tools: [
      ...
      { slug: "table-generator", name: "Markdown Table Studio", desc: "Visual grid editor for GitHub-flavored markdown tables", icon: "📐", added: "2026-09-18" },
      { slug: "slug-cleaner", name: "URL Slug Cleaner", desc: "Turn headlines into clean, SEO-friendly permalinks", icon: "🔗", added: "2026-09-18" },
  ...
  },
  {
    ...
    icon: "🧮",
    tools: [
      { slug: "interest-calculator", name: "Interest Calculator", desc: "Simple vs compound interest, side by side", icon: "📈" },
      ...
      { slug: "vat-calculator", name: "VAT / Sales Tax Calculator", desc: "Add or remove VAT at any rate, gross/net split", icon: "🧾" },
  ...
  },
  {
    ...
    icon: "💻",
    tools: [
      { slug: "uuid-generator", name: "UUID Generator", desc: "Bulk UUID v4 generation with one-click copy", icon: "🆔" },
      ...
      { slug: "json-to-ts", name: "JSON to TypeScript", desc: "Convert JSON to clean typed TypeScript interfaces", icon: "📐", added: "2026-09-18" },
      ...
      { slug: "jwt-decoder", name: "JWT Decoder", desc: "Decode JWT header & payload locally, safely", icon: "🔑" },
      { slug: "morse-code", name: "Morse Code Translator", desc: "Text ↔ Morse with audio and reference chart", icon: "📡" },
      { slug: "metronome", name: "Metronome", desc: "Precision BPM clicks, tap tempo, time signatures", icon: "🥁" },
  ...
  },
  {
    ...
    icon: "✍️",
    tools: [
      { slug: "word-frequency", name: "Word Frequency Analyser", desc: "Top words, density and repetition in any text", icon: "🔠" },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: "time-zone-meeting", name: "Meeting Time Planner", desc: "Find the fair slot across multiple time zones", icon: "🌐" },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: "matrix-screen", name: "Matrix Rain", desc: "Digital rain screensaver, full screen", icon: "🟩" },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: "nim", name: "Nim Strategy Trainer", desc: "Learn the winning trick of the classic counter game", icon: "🪙" },
      { slug: "code-breaker", name: "Code Breaker", desc: "Crack the hidden colour code (Mastermind)", icon: "🔐" },
      { slug: "word-scramble", name: "Word Scramble", desc: "Unscramble words against your streak", icon: "🔤" },
      { slug: "flashcard-maker", name: "Flashcard Maker", desc: "Create decks, study with spaced repetition", icon: "🧠" },
      { slug: "periodic-table", name: "Periodic Table", desc: "Interactive table - tap any element for facts", icon: "⚗️" },
