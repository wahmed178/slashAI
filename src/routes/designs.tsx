...
const DESIGNS: DesignCard[] = [
  ...
  },
  {
    ...
    name: 'Glass',
    brand: 'SlashAI',
    description: 'Liquid glass panels floating over a deep aurora backdrop - translucent cards, glossy edges, drifting light fields.',
    accent: '#6d8dff',
    accentLabel: 'Liquid Blue',
    vibe: 'Liquid Glass',
    bgPreview: '#101425',
    surfacePreview: '#232b4d',
    borderPreview: '#3d4a7d',
    features: [
      'Deep aurora backdrop',
      'Translucent glass panels',
      'Frosted floating menus',
      'Liquid blue accent',
      'Soft glows and depth',
    ],
  },
];
