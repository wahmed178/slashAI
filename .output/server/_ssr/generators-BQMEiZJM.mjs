//#region node_modules/.nitro/vite/services/ssr/assets/generators-BQMEiZJM.js
var GENERATORS = [
	{
		id: "business-names",
		...
		fields: [
			{
				...
				type: "textarea",
				required: true,
				placeholder: "A mobile app that turns receipts into automatic expense reports for freelancers."
			},
			{
				name: "audience",
				label: "Target audience",
				type: "text",
				placeholder: "Freelancers and solo consultants"
			},
			{
				name: "vibe",
				label: "Name vibe",
		...
		fields: [
			{
				...
				type: "textarea",
				required: true,
				placeholder: "A booking tool for boutique fitness studios with waitlists and class packs."
			},
			{
				name: "budget",
				label: "Budget range",
			...
			{
				name: "skills",
				label: "Your skills / team",
				type: "text",
				placeholder: "Solo founder, can code basic React"
			}
		]
	},
	{
		...
		fields: [
			...
			},
			{
				...
				type: "text",
				placeholder: "Works offline, no account needed"
			}
		]
	},
	{
		...
		fields: [
			...
			},
			{
				...
				type: "textarea",
				placeholder: "200 waitlist signups, 15 pilot users"
			},
			{
				name: "market",
	...
	},
	{
		...
		fields: [{
			...
			name: "model",
			label: "Revenue model hint",
			type: "text",
			placeholder: "Subscription + usage fees"
		}]
	},
	{
		id: "cold-email",
		...
		fields: [
			...
			},
			{
				...
				type: "text",
				required: true,
				placeholder: "Heads of ops at mid-size e-commerce brands"
			},
			{
				name: "goal",
		...
		fields: [
			{
				...
				type: "textarea",
				required: true,
				placeholder: "Onboarding a new client from signed proposal to kickoff call."
			},
			{
				name: "team",
			...
			},
			{
				...
				type: "text",
				placeholder: "Notion, Stripe, Slack"
			}
		]
	},
	{
		...
		fields: [
			{
				name: "context",
				label: "Team / company context",
				type: "textarea",
				required: true,
				placeholder: "Early-stage SaaS, 4 people, pre-revenue."
			},
			{
				name: "focus",
				label: "Biggest priority right now",
				type: "text",
				required: true
			},
			{
	...
	},
	{
		...
		fields: [
			...
			},
			{
				...
				type: "textarea",
				required: true,
				placeholder: "Email, usage analytics, preferences"
			},
			{
				name: "email",
				label: "Contact email",
	...
	},
	{
		...
		fields: [
			...
			{
				name: "offer",
				label: "Launch day special offer",
				type: "text"
			}
		]
	},
		...
		fields: [
			{
				...
				type: "text",
				required: true,
				placeholder: "SaaS tool for designers"
			},
			{
				name: "pricing",
				label: "Pricing model",
			...
			{
				name: "users",
				label: "Estimated users at month 1",
				type: "text",
				required: true,
				placeholder: "50"
			},
			...
			{
				name: "costs",
				label: "Monthly costs (hosting, tools, ads)",
				type: "text",
				placeholder: "$200"
			}
		]
	...
	},
	{
		...
		fields: [
			...
			{
				name: "partner",
				label: "Target partner / company type",
				type: "text",
				required: true
			},
			{
			...
			},
			{
				...
				type: "text",
				required: true,
				placeholder: "15-min call to explore integration"
			}
		]
	},
	{
		...
		fields: [
			...
			},
			{
				...
				type: "text",
				required: true,
				placeholder: "MRR, ARR, active users"
			},
			{
				name: "win",
				label: "Biggest win",
...
var GENERATOR_IDS = new Set(GENERATORS.map((g) => g.id));
function getGenerator(id) {
	return GENERATORS.find((g) => g.id === id);
}
var RUNS_KEY = "slashai.aiRuns";
function todayKey() {
...
function recordRun() {
	localStorage.setItem(RUNS_KEY, JSON.stringify({
		day: todayKey(),
		count: readRunCount() + 1
	}));
}
//#endregion
export { recordRun as a, readRunCount as i, GENERATOR_IDS as n, getGenerator as r, GENERATORS as t };
